...
#include "stanExports_mvn_infer1e.h"

RCPP_MODULE(stan_fit4mvn_infer1e_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mvn_infer1e")
